...
# User must have devtools installed
...
kableExtra::kable(my_session_info1, 'latex', row.names = F, booktabs = TRUE, linesep = '', caption = "Supplemental Table: Reproducibility Software Session Information") %>% kableExtra::kable_styling(font_size = 7)
...
# TABLE 2
# Need to split up code based on devtools version:
devtools_version <- my_session_info$packages$loadedversion[my_session_info$packages$package == 'devtools']
...
kableExtra::kable(my_session_info2, 'latex', row.names = F, booktabs = TRUE, linesep = '', caption = "Supplemental Table: Reproducibility Software Package Version Information") %>% kableExtra::kable_styling(font_size = 7)
