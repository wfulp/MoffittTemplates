...
kable(my_session_info1, 'latex', row.names = F, booktabs = TRUE, linesep = '', caption = "Supplemental Table: Reproducibility Software Session Information \\label{tab:session_info}") %>% kable_styling(font_size = 7)
...
kable(my_session_info2, 'latex', row.names = F, booktabs = TRUE, linesep = '', caption = "Supplemental Table: Reproducibility Software Package Version Information \\label{tab:session_info2}") %>% kable_styling(font_size = 7)
