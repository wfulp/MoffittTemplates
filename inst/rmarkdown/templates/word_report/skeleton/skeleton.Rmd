...
PT0N0_adj_fit_table <- run_pretty_model_output(
  ...
  event_in = NULL, event_level = 'Complete Response', latex_output = FALSE)
...
OS_adj_fit_table <- run_pretty_model_output(
  ...
  event_in = 'Vital_Status', event_level = 'Dead', latex_output = FALSE)
...
```{r Software-Session-Information, results = 'asis',eval=F}
...
```{r Software-Package-Version-Information, results = 'asis',eval=F}
