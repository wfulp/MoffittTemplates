...
options(xtable.comment = FALSE, datatable.verbose = FALSE, scipen = 10, knitr.kable.NA = '')   
...
kable(my_session_info1, 'pandoc', row.names = F, booktabs = TRUE, linesep = '', caption = "Supplemental Table: Reproducibility Software Session Information")

```

<br><br> 

```{r session2-info-table, results = 'asis'}


# TABLE 2
my_session_info2 <- packages[packages$`*` == '*', -2]  # Only want attached packages
...
kable(my_session_info2, 'pandoc', row.names = F, booktabs = TRUE, linesep = '', caption = "Supplemental Table: Reproducibility Software Package Version Information")
